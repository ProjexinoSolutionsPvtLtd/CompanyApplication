...
class ViewTask : ComponentActivity() {
        ...
        setContent {
            ...
            CompanyApplicationTheme {
                ...
                Surface(
                    ...
                    Drawer(
                        title = "View Tasks",
                        context = this@ViewTask,
                        activity = this@ViewTask,
                        onShareClicked = { viewModel.createTextFromTaskList(this@ViewTask) },
                        share = true,
                        content = {
                            if (viewModel.showContent) {
                                Box(Modifier.fillMaxSize()) {
                                    Column(
                                        ...
                                        SearchBar(hint = "Search Tasks", onSearch = {
